 ...
 * @author leoomoreira
 */
public class TelaAtualizarJogador extends javax.swing.JDialog {

    /**
     * Creates new form TelaAtualizarPessoa
     */
    public TelaAtualizarJogador(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ChangeOptions();
    }
    ...
    private void botaoAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAtualizarActionPerformed
        int opcao = JOptionPane.showConfirmDialog(this, "Deseja realmente atualizar este Jogador?", "Atualizar Jogador", JOptionPane.YES_NO_CANCEL_OPTION);
        if (opcao == JOptionPane.YES_OPTION) {
            try {
                ...
                textoNome.setText("");
                ChangeOptions();
                JOptionPane.showMessageDialog(this, "Jogador atualizada com sucesso", "Atualizar Jogador", JOptionPane.INFORMATION_MESSAGE);
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, ex.getMessage(), "Atualizar Jogador", JOptionPane.ERROR_MESSAGE);
            }
        }
